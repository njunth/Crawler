...
class spider( scrapy.Spider ):
    ...
    def parse(self, response):
        ...
        # while 1:
        urls = response.xpath(
            "//ul[@class='con_l']//a[starts-with(@href,'http')]/@href  |  //ul[@class='con_r']//a[starts-with(@href,'http')]/@href   |   //div[@class='tab_box']//a[starts-with(@href,'http')]/@href" ).extract()
        for url in urls:
    ...
    def parse_inPage(self, response):
        ...
        if timelist is None:
            ...
            while (i <= 18):
                timelist = \
                response.xpath( "//div[@class='information_details_title pb25']/span/text()" ).extract_first()[i]
